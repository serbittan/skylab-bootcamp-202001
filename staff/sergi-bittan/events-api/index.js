...
const { registerUser, authenticateUser, retrieveUser, publishEvent, retrievePublishedEvents, retrieveLastEvents, subscribeEvent, retrieveSubscribe, deleteEvent} = require('./routes')
